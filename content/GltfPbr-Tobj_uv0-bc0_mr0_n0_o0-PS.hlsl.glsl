...
float getSpotShadow(Light light, vec3 Pw)
{
    ...
    vec3 _525 = p4Shadow.xyz / vec3(p4Shadow.w);
    p4Shadow = vec4(_525.x, _525.y, _525.z, p4Shadow.w);
...
PsOut src_main(VsOut psIn)
{
    ...
    vec3 _225 = psOut.rgbaColor.xyz * occlusionSample.x;
    psOut.rgbaColor = vec4(_225.x, _225.y, _225.z, psOut.rgbaColor.w);
    vec3 rgbEmissive = cbPerObject.g_perObjectPbrFactors.rgbaEmissive.xyz * cbPerFrame.g_fPerFrameEmissiveFactor;
    vec3 _242 = psOut.rgbaColor.xyz + rgbEmissive;
    psOut.rgbaColor = vec4(_242.x, _242.y, _242.z, psOut.rgbaColor.w);
    return psOut;
}
