...
float getSpotShadow(Light light, vec3 Pw)
{
    ...
    vec3 _540 = p4Shadow.xyz / vec3(p4Shadow.w);
    p4Shadow = vec4(_540.x, _540.y, _540.z, p4Shadow.w);
...
PsOut src_main(VsOut psIn)
{
    ...
    vec3 _257 = psOut.rgbaColor.xyz + rgbEmissive;
    psOut.rgbaColor = vec4(_257.x, _257.y, _257.z, psOut.rgbaColor.w);
    return psOut;
}
