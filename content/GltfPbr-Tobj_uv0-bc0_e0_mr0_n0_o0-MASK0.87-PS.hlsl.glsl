...
float getSpotShadow(Light light, vec3 Pw)
{
    ...
    vec3 _553 = p4Shadow.xyz / vec3(p4Shadow.w);
    p4Shadow = vec4(_553.x, _553.y, _553.z, p4Shadow.w);
...
PsOut src_main(VsOut psIn)
{
    ...
    PbrParams _166 = metallicRoughness(param_var_psIn_1);
    PbrParams pbrParams = _166;
    PsOut psOut;
    ...
    PbrParams param_var_pbrParams = pbrParams;
    vec3 _196 = applySpotLight(param_var_light, param_var_Nw, param_var_Vw, param_var_Pw, param_var_pbrParams);
    psOut.rgbaColor = vec4(_196.x, _196.y, _196.z, psOut.rgbaColor.w);
    PbrParams param_var_pbrParams_1 = pbrParams;
    vec3 param_var_N = Nw;
    vec3 param_var_V = Vw;
    vec3 _213 = psOut.rgbaColor.xyz + (getIbl(param_var_pbrParams_1, param_var_N, param_var_V) * cbPerFrame.g_fIblFactor);
    ...
    vec3 _232 = psOut.rgbaColor.xyz * occlusionSample.x;
    psOut.rgbaColor = vec4(_232.x, _232.y, _232.z, psOut.rgbaColor.w);
    ...
    vec3 _261 = psOut.rgbaColor.xyz + rgbEmissive;
    psOut.rgbaColor = vec4(_261.x, _261.y, _261.z, psOut.rgbaColor.w);
    return psOut;
}
...
void main()
{
    ...
    PsOut _125 = src_main(param_var_psIn);
    out_var_SV_TARGET = _125.rgbaColor;
}
