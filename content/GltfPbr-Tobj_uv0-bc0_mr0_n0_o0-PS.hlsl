...
Texture2D g_tNormal : register(t2);
SamplerState g_sNormal : register(s2);
Texture2D g_tOcclusion : register(t3);
SamplerState g_sOcclusion : register(s3);
Texture2D g_tIblBrdfLut : register(t4);
SamplerState g_sIblBrdfLut : register(s4);
TextureCube g_tIblDiffuse : register(t5);
SamplerState g_sIblDiffuse : register(s5);
TextureCube g_tIblSpecular : register(t6);
SamplerState g_sIblSpecular : register(s6);
...
PsOut main(VsOut psIn)
{
	...
	psOut.rgbaColor.rgb *= occlusionSample.x;
